  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const { error: signUpError } = await supabase.auth.signUp({
        ...
        options: {
          data: {
            // This 'display_name' is crucial. 
            // It triggers our SQL function to create the 'profiles' row.
      ...
      // 2. Success handling
      // Note: In a real app, you might check if email confirmation is required.
